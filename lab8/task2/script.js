...
// Створює і керує слайдером з заданою конфігурацією
const createSlider = (containerId, config) => {
    ...
    // Оновлює позицію та активну крапку (continuous loop через нормалізацію індексу)
    const updateSlider = () => {
    ...
    // Зупинка автоплею при наведенні
