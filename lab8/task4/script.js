...
const updateUIForMode = () => {
    ...
    // Оновлюємо draggable атрибут на існуючих картках
...
// Визначає над якою карткою зараз курсор для коректної вставки
...
grid.addEventListener('drop', (e) => {
    if (!isEditMode) return;
    e.preventDefault();
    // Синхронізуємо масив languages з новим порядком DOM
